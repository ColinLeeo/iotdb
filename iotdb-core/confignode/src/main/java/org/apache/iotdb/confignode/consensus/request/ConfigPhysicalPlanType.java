...
public enum ConfigPhysicalPlanType {
  ...
  RGrantUserDBPriv((short) 650),
  RGrantUserTBPriv((short) 651),
  RGrantRoleDBPriv((short) 652),
  RGrantRoleTBPriv((short) 653),
  RRevokeUserAny((short) 654),
  RRevokeRoleAny((short) 655),
  RRevokeUserDBPriv((short) 656),
  RRevokeUserTBPriv((short) 657),
  RRevokeRoleDBPriv((short) 658),
  RRevokeRoleTBPriv((short) 659),
  RGrantUserSysPri((short) 660),
  RGrantRoleSysPri((short) 661),
  RRevokeUserSysPri((short) 662),
  RRevokeRoleSysPri((short) 663),
  RListUser((short) 664),
  RListRole((short) 665),
  RListUserPrivilege((short) 666),
  RListRolePrivilege((short) 667),
